...
//               className="relative p-2 text-slate-600 hover:text-emerald-600 transition-colors duration-200 rounded-lg hover:bg-white/10"
//             >
...
const Navigation: React.FC = () => {
  const { currentUser, currentPage, setCurrentPage, cartItems } = useApp();
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
