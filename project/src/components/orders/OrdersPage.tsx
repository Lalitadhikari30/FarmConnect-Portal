  ...
  const orders = [
    {
      ...
      items: [
        { name: 'Heirloom Tomatoes', quantity: '2 lbs', price: 12.00 },
    ...
    },
    {
      ...
      items: [
        { name: 'Mixed Berries', quantity: '1.5 lbs', price: 18.00 },
        { name: 'Organic Apples', quantity: '3 lbs', price: 14.00 }
      ],
      total: 32.00,
      status: 'shipped',
    ...
    },
    {
      ...
      items: [
        { name: 'Fresh Carrots', quantity: '2 lbs', price: 6.00 },
        { name: 'Bell Peppers', quantity: '1.5 lbs', price: 9.00 },
        { name: 'Zucchini', quantity: '2 lbs', price: 7.00 }
      ],
      total: 22.00,
      status: 'preparing',
